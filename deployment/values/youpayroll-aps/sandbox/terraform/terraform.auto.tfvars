...
application_secret_provider_class_charts = [
  # youpayroll-aps-envs
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-spc"
...
application_migration_charts = [
  # migration
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-migration"
    chart            = "migration"
    version          = "1.0.3"
    timeout          = 600
    wait             = true
  ...
  # collectstatic
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-collectstatic"
    chart            = "collectstatic"
    version          = "1.0.3"
    timeout          = 600
    wait             = true
...
application_charts = [
  # app
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-app"
    chart            = "app"
    version          = "1.0.3"
    timeout          = 1200
    atomic           = true
  ...
  # cron
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-cron"
    chart            = "cron"
    version          = "1.0.2"
    timeout          = 600
    atomic           = true
  ...
  # ingress
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-ingress"
    chart            = "ingress"
    version          = "1.0.0"
    timeout          = 600
    atomic           = true
  ...
  # nginx
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-nginx"
    chart            = "nginx"
    version          = "1.0.4"
    timeout          = 600
    atomic           = true
  ...
  # worker
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-worker"
    chart            = "worker"
    version          = "1.0.3"
    timeout          = 600
    atomic           = true
  ...
  # consumer-name
  {
    ...
    create_namespace = false
    repository       = "oci://459037613883.dkr.ecr.us-east-1.amazonaws.com/production/helm/ygag"
    release_name     = "youpayroll-aps-consumer-name"
