...
urlpatterns = [
    # Admin URL - restored to standard 'admin/' as obscured paths are not true security
    path('admin/', admin.site.urls),
    
    # Modern Health Probes - Standardized with trailing slashes to avoid 301 redirects
