...
#   2. A CheckConstraint that prevents False values from bypassing singleton enforcement.
#   3. A UniqueConstraint on `singleton_lock` so the DB guarantees only one row.
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Step 3: Prevent False values from bypassing singleton enforcement.
        ...
        # Step 4: Enforce uniqueness at the DB level — only one True value allowed.
        migrations.AddConstraint(
            model_name='zohopeopleformtoken',
